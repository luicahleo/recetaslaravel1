...
@section('botones')
    ...
    <a href="{{ route('recetas.index') }}" class="btn btn-outline-primary">Volver</a>
@endsection

@section('content')

    <h2 class="text-center mt-5">Editar receta {{ $receta->titulo }}</h2>
...
{{--                Agregamos esta linea de PUT porque HTML no soporta PUT--}}
                @method('PUT')
